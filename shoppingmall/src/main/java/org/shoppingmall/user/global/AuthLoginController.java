...
public class AuthLoginController {
    ...
    @GetMapping("/google")
    public ResponseEntity<ApiResponseTemplate<LoginResDto>> googleCallback(@RequestParam String code, @RequestParam String state) {
        UserStatus status = state.equalsIgnoreCase("SELLER") ? UserStatus.ROLE_SELLER : UserStatus.ROLE_USER;
    ...
    @GetMapping("/kakao")
    public ResponseEntity<ApiResponseTemplate<LoginResDto>> kakaoCallback(@RequestParam String code, @RequestParam String state) {
        UserStatus status = state.equalsIgnoreCase("SELLER") ? UserStatus.ROLE_SELLER : UserStatus.ROLE_USER;
